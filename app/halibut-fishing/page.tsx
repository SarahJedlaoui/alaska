            ...
            <div className="w-full px-4 lg:w-8/12">
              <div>
                ...
                <div>
                  ...
                  Welcome to the AKA Halibut fishing information page.   Here you’ll find all the information you need about your Halibut fishing adventure with Alaska Kenai Adventures.
                  </p>
                  ...
                  The average Halibut taken by sport anglers in Alaska ranges between 15 and 40 pounds, with fish up to 100 pounds a regular occurrence. Fish over 150 are relatively rare, making up about 8-10% of the sport catch.
                  </p>
                  <p className="mb-1 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                  The Halibut limit is two per day per Angler.
                  </p>
                  <p className="mb-10 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                  The halibut season is June 1st – September 6th.
                  </p>
