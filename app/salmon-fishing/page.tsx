...
const BlogDetailsPage1 = () => {
              ...
              <div>
                ...
                <div>
                  <p className="mb-1 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                    Sockeye salmon are of the highest quality of salmon available. Kenai River sockeye salmon average 6-8 pounds.  During the peek run the sockeye limit is six fish per day, per angler.
                  ...
                  <p className="mb-5 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                    Sockeye run from early July through mid August.
                  </p>
  ...
  rel="noreferrer" >
                  ...
                  <h3 className="font-xl mb-10 font-bold leading-tight text-black dark:text-white sm:text-2xl sm:leading-tight lg:text-xl lg:leading-tight xl:text-2xl xl:leading-tight">
                    King and Coho Salmon Fishing
                  </h3>

                  <p className="mb-1 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                    Alaska’s biggest fish are King Salmon, which can run up to 90 pounds. Coho Salmon are hard fighting and can get up to 20 pounds!
                  </p>
                  <p className="mb-1 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                    Silver’s (Coho) run from mid August through October.
                  </p>
                  <p className="mb-10 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                    Kings run from June to mid August.
                  </p>

                  <div className="mb-10 w-full overflow-hidden rounded">
                    <div className="relative aspect-[97/60] w-full sm:aspect-[97/44]">
                      <Image
                        src="/images/blog/hal1.jpg"
                        alt="image"
                        fill
                  ...
                  <div className="flex mb-10">
                    <div className="w-1/2 overflow-hidden rounded">
                      <div className="relative aspect-[97/90] sm:aspect-[97/90]">
                        <Image
                          src="/images/blog/hal2.jpg"
                          alt="image"
                          fill
                          className="object-cover object-center"
                        />
                  ...
                  <div className="flex mb-10">
                    <div className="w-1/2 overflow-hidden rounded">
                      <div className="relative aspect-[97/40] sm:aspect-[97/90]">
                        <Image
                          src="/images/blog/hal3.jpg"
                          alt="image"
                          fill
                          className="object-cover object-center"
                        />
                  ...
                  <div className="flex mb-10">
                    <div className="w-1/2 overflow-hidden rounded">
                      <div className="relative aspect-[97/40] sm:aspect-[97/70]">
                        <Image
                          src="/images/blog/hal8.jpg"
                          alt="image"
                          fill
                          className="object-cover object-center"
                        />
                  ...
                  <div className="relative z-10 mb-10 overflow-hidden rounded-md bg-primary bg-opacity-10 p-8 md:p-9 lg:p-8 xl:p-9">
                    <h3 className="text-center font-xl mb-10 font-bold leading-tight text-black dark:text-white sm:text-2xl sm:leading-tight lg:text-xl lg:leading-tight xl:text-2xl xl:leading-tight">
  ...
  rel="noreferrer" >
                    ...
                    <div className="mb-10 w-full overflow-hidden rounded">
                    <div className="relative aspect-[97/60] w-full sm:aspect-[97/68]">
                      <Image
                        src="/images/blog/table.png"
                        alt="image"
                        fill
                        className="object-cover object-center"
                      />
